...
\textbf{Add calculation of secular forcing timescale here}
...
second order and higher MMRs, the maximum libration width is given by \sout{equation 8.58} in \citet{1999ssd..book.....M} \text{bf}(ch. 8, pg 338, eq. 8.58) as
