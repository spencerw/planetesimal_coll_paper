...
% TRQ: there should be a reference (or references) for the equations
% below.  Perhaps something like "Below we derive the libration widths
% following Murray & Dermott, chapter XX.
...
integration symplectic, we find that a small amount of artificial
precession is produced.
% TRQ: should we say why?
This is most noticeable at the inner edge of the
planetesimal disk.
% TRQ: so are all particles on a base timestep of 0.0025 yr?
We reduce the base time step size by an additional factor of 4 to the prevent the longitude of perihelia of planetesimals at the inner edge of the disk from drifting by more than the intrinsic spread in $\varpi$ due to the free eccentricity over the course of our integrations.
...
time step.
% TRQ: this shorter timestep is still larger than the planetesimal
% dynamical time; is this a problem?
...
%TRQ: I'm not seeing that much of a gap compared to e2m2 and e2m1.
...
% TRQ: define PWV
setting $\rm PWV=1.5$. They are then combined, imaged, and cleaned
...
% TRQ: perhaps mention "2:1" somewhere in the caption.
\begin{figure}
\begin{center}
...
% TRQ: it took me a while to understand the dashed lines.  Is the
% following correct: the lower dashed line is where the apo/peri of
% the inner/outer edges of the resonance begin to overlap; the upper
% dashed line is when the overlap is equal to the width of the
% resonance?  Perhaps spell this out?
...
% TRQ: perhaps a short definition of "strength" here?
...
%TRQ: perhaps thinner dashed lines for the MMRs?  It isn't easy to see
%the gaps in the interior resonances.
\begin{figure*}
