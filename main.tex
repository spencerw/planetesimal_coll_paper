...
In figure \ref{fig:alma_profiles}
\footnote{The simulated brightness profiles, along with the sky models are available at \url{https://github.com/spencerw/planetesimal_coll_paper}}, we show the 
