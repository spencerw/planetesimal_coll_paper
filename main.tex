...
second order and higher MMRs, the maximum libration width is given by equation 8.58 in \citet{1999ssd..book.....M} as
...
\noindent (see \citet{1999ssd..book.....M} table 8.1) where $D b^{j}_{s}$ is the first derivative with respect to $\alpha$ of the Laplace coefficient defined in equation \ref{eq:lap}. This is given by \citet{1961mcm..book.....B} as
...
\noindent (see \citet{1999ssd..book.....M} table 8.1) and there is an additional contribution to the motion of the critical angle by the pericenter precession rate such that
...
\noindent (see \citet{1999ssd..book.....M} equation 8.76).
