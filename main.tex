...
\begin{abstract}
\textbf{In circumstellar discs, collisional grinding of planetesimals
  produces second-generation dust. While it remains unclear whether this becomes a major component of the total dust content, 
...
So far, studies of planetesimal dynamics near MMRs \textbf{in which the planetesimals are directly resolved} have involved either collisionless test particles 
...
%TRQ: do you need "St" here?  I don't think it's used elsewhere in the paper.St $\equiv t_{s} \Omega$ = 1. In the Stokes drag regime at 3 au, this occurs for bodies of 1 meter in size. Following a similar 
