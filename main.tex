...
surface density of the disc near the locations of resonances, while producing a pileup of bodies on eccentric orbits adjacent to the MMR. \textbf{TODO: split this into a separate section, discussion the safronov collision rate} The 
...
coupled to the gas. \textbf{TODO: Shorten this a bit, since we introduce this timescale in section \ref{sec:dynamics}.} For a dust grain larger than the mean free path of the gas particles, the timescale to damp its eccentricity is given by 
\citep{1976PThPh..56.1756A}
