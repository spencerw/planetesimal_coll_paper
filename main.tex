...
equilibrium near the resonances before the collision rate is measured. \textbf{TODO: Remove this, discussion of libration timescale has been moved to section \ref{sec:dynamics}}. The libration timescale, which describes how long the critical angle (and also 
...
\begin{equation}\label{eq:lib_time_old}
