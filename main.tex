...
\begin{figure}
    ...
    \caption{The semimajor axis and eccentricities of planetesimals at the end of the eccentric Jupiter simulations. Near the location of mean motion resonances, the resonant angle librates and drives corresponding oscillations in eccentricity. Due to the conservation of the Jacobi energy, these changes in eccentricity also drive slight, inward changes in semimajor axis.\label{fig:ae}}
    \end{center}
\end{figure}
...
\begin{figure}
    ...
    \caption{The semimajor axis and pericenter orientation of remaining planetesimals at the end of the eccentric Jupiter simulations. When the forced eccentricity of the planetesimal disk is large, planetesimals near the edge of the mean motion resonances become more resistant to precession induced by the resonances.\label{fig:long_ph}}
    \end{center}
\end{figure}
...
\begin{figure*}
    ...
    \caption{KDE of the number of collisions at a given heliocentric distance for planetesimals inside (left) and outside (right) of the 2:1 MMR. In the $e_{pl} = 2 e_{jup}$ case, a bump, rather than a dip appears near the 2:1 MMR (see figure \ref{fig:coll_hist_e_and_m}). This bump is produced by non-resonant planetesimals undergoing collisions near the center of the 2:1 MMR. In the right panel, the dashed curves represent collisions where the longitude of perihelion of either collider was strongly misaligned with Jupiter. In the high eccentricity case, bodies near the edge of the resonance with randomly oriented orbits can reach across the resonance and collide with planetesimals on the other side.\label{fig:coll_hist_r_inout_res}}
    \end{center}
\end{figure*}
