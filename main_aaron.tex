...
constrain the orbital properties of the perturbing planet.
 ...
 \ACBc{[Feel free to omit this, particularly because it has a self citation, but I think it is important to highlight that your results could be relevant beyond debris systems]  While the focus here is on the evolution of planetesimal disks in general, with the most direct application being debris systems, we note that the results may be relevant for interpreting structures observed in young, gas-rich disks. For example, assuming giant planet formation requires first the presence of planetesimals, then systems such as HL Tau that have purported embedded giant planets, could have localized regions of dust enhancement due to the corresponding planetesimal collisions  \citep{2017ApJ...850..103B}.  The main difference between such cases and debris disks is that the dust in the former situation couples to gas. }
...
pendulum. Variations in the critical angle are coupled to changes in the mean motion and semimajor axis \citet{2000ssd..book.....M}. An important 
point to note, which will become important later, is that the variation frequency of this angle approaches zero near the edge of a resonance. The 
...
\begin{center}
    ...
    \caption{\ACBc{fix aspect ratino so a circle is a circle.}  The positions of the remaining planetesimals at the end of the e1m2 (left), e2m2 (center) and e3m2 (right) simulations. The red dot 
...
\citet{2016ApJ...818..159T} (figure 3). It is worth noting that \citet{2000Icar..143...45R} started with a completely cold planetesimal disk and a Jupiter 
mass planet on a circular, coplanar orbit. The presence of these features seems robust to the choice of initial conditions.
...
This also suggests that the most prominent bumps and dips seen in figure \ref{fig:coll_hist_r} are being produced by bodies outside of resonance. To 
further understand this, we consider the nonaxisymmetric structure seen in figure \ref{fig:xy}. In figure \ref{fig:coll_polar_e}, we compare the radial 
collision profile to the radial structure seen in the e1m2, e2m2 and e3m2 simulations. In the lowest forced eccentricity case, the pileups near the 
edges of the resonances line up with the boundaries of the dip feature seen in the radial collision profile. The locations of the edges of the 
resonances are calculated using equations \ref{eq:res_fo} and \ref{eq:res_so}. The pileups are especially prominent for the 2:1 resonance. As 
discussed previously, the pileups and gaps seen in polar coordinates follow the position of the giant planet in its orbit, which is shown by the vertical 
line.
...
planet planet on a circular orbit, this structure is still present (see figure 3 of \citet{2016ApJ...818..159T}). The only relation between the structure of 
...
simply include them as an extra curve in the side panels of figures 6 and 7 like I've started to do here?
